...
\begin{longtable}[]{@{}ll@{}}
\toprule
\(\Omega_{\ }^{*}(s) = \ \operatorname{}{\sum_{s' \in S\ }^{\ }{P\left( s'|s,a \right)\left( R\left( s,a,s' \right) + \gamma V\left( s' \right) \right)}}\)
& ()\tabularnewline
\bottomrule
\end{longtable}\strut
...
\(\pi_{\ }^{*}\left( s \right) = \pi_{u}^{*}\left( s \right) \cup \pi_{l}^{*}\left( s \right)\).
...
\begin{longtable}[]{@{}ll@{}}
\toprule
\(\pi_{\ }^{\ }\left( s \right) = \left\{ \pi_{u}^{\ }\left( s \right),\pi_{l}^{\ }\left( s \right) \right\}\)
& ()\tabularnewline
\bottomrule
\end{longtable}
...
\begin{longtable}[]{@{}ll@{}}
\toprule
\(\Omega_{\ }^{*}(a) = \ \operatorname{}{\sum_{s' \in S\ }^{\ }{P\left( s'|s,a \right)\left( R\left( s,a,s' \right) + \gamma V\left( s' \right) \right)}}\)
& ()\tabularnewline
\bottomrule
\end{longtable}\strut
\end{minipage} & \begin{minipage}[t]{0.48\columnwidth}\raggedright\strut
